...
import { useStyling, useSpell, Hotkey, ActivationMode, type ActivationConditions } from 'cedar-os';
...
const Corner: React.FC<CornerProps> = ({ thickness = 2, length = 10, color, ...position }) => (
  <>
    <motion.div
      layout
      className="absolute"
